"""
67-parameter trained transformer for 10-digit addition.
100% accuracy (10010/10010) on AdderBoard. Trained from scratch, seed 71046.
...
def build_model():
    ...
    ckpt_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "checkpoint_67p.pt")
